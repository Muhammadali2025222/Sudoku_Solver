...
{
	public:
		static bool compare_Row0_Row1_dimensions(int new_sudoku_3d[9][9][10]) 
		{
		...
		static bool compare_Row0_Row2_dimensions(int new_sudoku_3d[9][9][10]) 
		{
			for (int row = 0; row < 9; row++)
			{
				for (int col = 0; col < 9; col++)
		...
		static void multiple_possibility_column_eliminator(int sudoku_2d[9][9], int new_sudoku_3d[9][9][10])
		{
			for (int col = 0; col < 9; col++)
			{
				for (int row = 0; row < 9; row++)
